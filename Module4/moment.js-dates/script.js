...
// My Birthdate
const birthDate = moment("1980-07-10");
...
// Years added to birthdate
const birthDateAndYears = birthDate.clone().add(years, "years");

// Remaining months
const months = currentDate.diff(birthDateAndYears, "months");

// Months added
const birthDateAndYearsAndMonths = birthDateAndYears.clone().add(months, "months");

// Remaining days
const days = currentDate.diff(birthDateAndYearsAndMonths, "days");

// ----------------------------------------------
//

// 3. Given two dates, display the date closest to the current date
const date1 = moment("2026-02-05");
const date2 = moment("2026-09-15");

const differenceFromDate1 = Math.abs(currentDate.diff(date1, "days"));
const differenceFromDate2 = Math.abs(currentDate.diff(date2, "days"));
...
<p><strong>3. </strong> Given two dates, display the date closest to the current date:<br> ${closestDate.format("DD MMMM YYY")} </p>
